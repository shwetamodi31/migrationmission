...
function LocalNews() {
  ...
  useEffect(() => {
    ...
    fetch('https://newsapi.org/v2/top-everything?q=india&news&from=2024-01-08&apiKey=02210ce4ebcd4ef6b5d6a03fefdf4da8')
      .then(response => {
        // Log the status code
      ...
      .then(data => {
        ...
        // Set the localNewsData state
        setLocalNewsData(data.articles);
      })
